...
- Skills und Systemzugriffe der Agenten werden **zentral verwaltet**
...
| Gemeinsame Skill-Bibliothek | ✗ | ✓ |
| Self-hosted & OSS | teilweise | ✓ immer |
...
|---|:---:|:---:|
| `kubectl delete pod x` | `default allow = false` | 🚫 blocked |
| `kubectl get pods -n prod` | `allowed := {"get"}` | ✅ executed |
